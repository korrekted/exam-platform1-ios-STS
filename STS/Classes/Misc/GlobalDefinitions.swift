...
final class GlobalDefinitions {
    ...
    static let apiKey = "QB8GkNHP6QGEEztd"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "MZn3m21fkUvvMsK1"

    static let applicationTag = "EXAM_STS"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/sts-exam/id1626945713"
    static let appleAppID = "1626945713"
